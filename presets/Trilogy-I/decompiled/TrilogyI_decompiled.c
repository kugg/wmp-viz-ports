=== DECOMPILED FUNCTIONS: TrilogyI.dll ===
...

{
  ...
  if (((param_1 == 0) && (DAT_10024ff8 != (int *)0x0)) && (*param_3 == 0x2e)) {
    uVar1 = GetAsyncKeyState(0x12);
    if ((uVar1 & 0x8000) != 0) {
      uVar1 = GetAsyncKeyState(0x11);
      if ((uVar1 & 0x8000) != 0) {
        Cleanup_WindowState(DAT_10024ff8);
      }
    }
  }
  CallNextHookEx(DAT_10024ff4,param_1,param_2,(LPARAM)param_3);
  return;
}
  ...
  *(undefined4 *)(param_1 + 0x44) = 0;
  if (DAT_10024ff8 == param_1) {
    ...
    if (DAT_10024ff4 != (HHOOK)0x0) {
      UnhookWindowsHookEx(DAT_10024ff4);
      DAT_10024ff4 = (HHOOK)0x0;
    }
  }
...

{
  ...
  strLen = LoadStringA(*(HINSTANCE *)(DAT_10024ff0 + 8),0x65,szDisplayName,0x200);
  Ordinal_6();
  if (strLen != 0) {
...

{
  ...
  *param_1 = 0;
  wsprintfW(local_10,u___06X_100240fc,
...

{
  ...
  if (param_2 == 1) {
    _DAT_10025080 = &DAT_10024098;
    DAT_10024ff0 = &g_pTrilogyState;
    g_pTrilogyState = 0x84;
    _DAT_10025074 = 0x300;
    g_hInstance = &PTR_DAT_10024108;
    g_hModule = param_1;
    _DAT_1002501c = param_1;
    DAT_10025014 = param_1;
    g_hMsgHook = 0;
    g_hVizWindow = (HANDLE)0x0;
    InitializeCriticalSection((LPCRITICAL_SECTION)&g_csInit);
    InitializeCriticalSection((LPCRITICAL_SECTION)&DAT_10025044);
    ...
    _DAT_1002508c = 0;
    DAT_10025088 = 0;
    DAT_10025090 = (undefined4 *)0x0;
    if (g_hInstance != (undefined **)0x0) {
      puVar1 = *g_hInstance;
      ppuVar6 = g_hInstance;
      while (puVar1 != (undefined *)0x0) {
        (*(code *)ppuVar6[8])(1);
        if (g_pTrilogyState == 100) {
          ppuVar6 = ppuVar6 + 7;
        }
        else {
          ppuVar6 = ppuVar6 + 9;
    ...
    _DAT_10025000 = DAT_10021418;
    _DAT_10025004 = DAT_1002141c;
    _DAT_10025008 = DAT_10021420;
    _DAT_1002500c = DAT_10021424;
    DisableThreadLibraryCalls(param_1);
    return 1;
  }
  if (param_2 == 0) {
    if (g_hInstance != (undefined **)0x0) {
      iVar2 = (int)*g_hInstance;
      piVar7 = (int *)g_hInstance;
      while (iVar2 != 0) {
        piVar3 = (int *)piVar7[4];
        if (piVar3 != (int *)0x0) {
    ...
    DeleteCriticalSection((LPCRITICAL_SECTION)&g_csInit);
    DeleteCriticalSection((LPCRITICAL_SECTION)&DAT_10025044);
    ...
    if ((g_hVizWindow != (HANDLE)0x0) && (DAT_1002507c != '\0')) {
      if (DAT_10025088 != 0) {
        uVar8 = 0;
        do {
          HeapDestroy(*(HANDLE *)(DAT_10025088 + uVar8 * 4));
          uVar8 = uVar8 + 1;
        } while (uVar8 <= DAT_10025084);
      }
      HeapDestroy(g_hVizWindow);
    }
  }
  return 1;
}
...

{
  ...
  iVar4 = Reg_RegisterServer(0x10025010,(LPCWSTR)0x0);
  return iVar4;
}
...

{
  ...
  do {
    if (iVar1 == 0) {
      Reg_UnregisterServer(0x10025010,(LPCWSTR)0x0);
      return 0;
    }
    if ((((code *)piVar3[6] == (code *)0x0) || (iVar1 = (*(code *)piVar3[6])(), iVar1 == 0)) &&
       ((*(code *)piVar3[1])(0), g_pTrilogyState == 0x84)) {
...
LAB_10010c6d:
      if (g_pTrilogyState != 100) goto LAB_10010c7b;
      piVar3 = piVar3 + 7;
    }
    iVar1 = *piVar3;
  } while( true );
...

{
  ...
  if (param_4 != (undefined4 *)0x0) {
    piVar1 = (int *)0x0;
    if (DAT_1002416c == (int *)0x0) {
      piVar1 = FUN_10014250(&PTR_DAT_10024160,param_3);
    }
    *param_4 = DAT_1002416c;
    if (DAT_1002416c != (int *)0x0) {
      (**(code **)(*DAT_1002416c + 4))(DAT_1002416c);
      piVar1 = (int *)0x0;
    }
  }
  return piVar1;
...

{
  ...
  local_8 = 0;
  GetModuleFileNameA(*(HMODULE *)(DAT_10024ff0 + 4),szModulePath,0x104);
  if ((*(int *)(param_1 + 4) == 0) ||
...
LAB_10011bce:
  ...
  *pWVar4 = L'\0';
  StringBuffer_Append(&local_20,u_Module_100241c4,(LPCWSTR)&stack0xfffffdcc);
  if (param_4 != (undefined4 *)0x0) {
  ...
  if (param_3 == 0) {
    iVar8 = lstrlenW(u_REGISTRY_100241b0);
    FUN_1001a4d0();
    WideCharToMultiByte(0,0,u_REGISTRY_100241b0,-1,&stack0xfffffdcc,iVar8 * 2 + 2,(LPCSTR)0x0,
                        (LPBOOL)0x0);
  }
  else {
    iVar8 = lstrlenW(u_REGISTRY_100241b0);
...

{
  ...
  if (cVar3 != '\0') {
    ...
    if ((DAT_1002543c & 1) == 0) {
      DAT_1002543c = DAT_1002543c | 1;
      DAT_1002509c = 8;
      DAT_10025098 = PTR_DAT_100213e8;
      DAT_100250a0 = PTR_DAT_100213ec;
      _DAT_100250a4 = 0x13;
      _DAT_100250a8 = PTR_DAT_100213f0;
      _DAT_100250ac = 0x11;
    }
    iVar4 = 0;
    puVar12 = &DAT_10025098;
    do {
      iVar6 = lstrcmpiA(local_2014,(LPCSTR)*puVar12);
      if (iVar6 == 0) {
        sVar2 = (&DAT_1002509c)[iVar4 * 4];
        goto LAB_100136cc;
      }
      puVar12 = puVar12 + 2;
      iVar4 = iVar4 + 1;
    } while (puVar12 < &DAT_100250b0);
  }
  return 0x80020009;
LAB_100136cc:
  do {
...
LAB_10013e02:
    ...
    lstrcpyA(lpString1,&DAT_100242b0);
    if (&stack0x00000000 == (undefined1 *)0x128) {
      pWVar7 = (LPWSTR)0x0;
    }
    else {
  ...
  if ((-1 < iVar2) && (iVar3 = (**(code **)(*local_14 + 0x1c))(local_14,&param_1), -1 < iVar3)) {
    hOleaut32Module = LoadLibraryA(s_oleaut32_dll_100242a0);
    if (hOleaut32Module != (HMODULE)0x0) {
      pfnUnRegisterTypeLib = GetProcAddress(hOleaut32Module,s_UnRegisterTypeLib_1002428c);
  ...
  if (*(int *)((int)this + 0xc) == 0) {
    ...
    if ((*(int *)((int)this + 0xc) == 0) &&
      ...
      if (-1 < (int)piStack_28) {
        ...
        iVar2 = (**(code **)*unaff_EBP)(unaff_EBP,&DAT_100242b8,&stack0xffffffd4);
        piVar6 = unaff_EBP;
        piVar10 = (int *)0x0;
        if (-1 < iVar2) {
...

{
  ...
  if (param_1 != (LPVOID)0x0) {
    ...
    FUN_1001aa20(9);
    HeapFree(g_hProcessHeap,0,param_1);
  }
  return;
}
...

{
  ...
  pvVar1 = __nh_malloc(_Size,DAT_10025148);
  return pvVar1;
}
...

{
  ...
  piVar1 = HeapAlloc(g_hProcessHeap,0,(int)param_1 + 0xfU & 0xfffffff0);
  return piVar1;
}
...
{
  PTR_LAB_100243d4 = &LAB_1001b7fa;
  PTR_LAB_100243d0 = __cfltcvt;
  PTR_LAB_100243d8 = __fassign;
  PTR_LAB_100243dc = FUN_1001b7a0;
  PTR_LAB_100243e0 = &LAB_1001b848;
  PTR_LAB_100243e4 = __cfltcvt;
  return;
}
...

{
  ...
  DAT_100242f4 = param_1;
  DAT_100242f0 = in_EAX;
  DAT_100242f8 = unaff_EBP;
  return;
}
...

{
  ...
  DAT_100242f4 = *(undefined4 *)(unaff_EBP + 8);
  DAT_100242f0 = in_EAX;
  DAT_100242f8 = unaff_EBP;
  return;
}
...

{
  ...
  if (local_24.wMinute == DAT_100250c8._2_2_) {
    if (local_24.wHour == (WORD)DAT_100250c8) {
      if (local_24.wDay == DAT_100250c4._2_2_) {
        if (local_24.wMonth == DAT_100250c0._2_2_) {
          if (local_24.wYear == (WORD)DAT_100250c0) goto LAB_1001a493;
        }
      }
    }
  }
  ...
  DAT_100250c0._0_2_ = local_24.wYear;
  DAT_100250c0._2_2_ = local_24.wMonth;
  DAT_100250c4._0_2_ = local_24.wDayOfWeek;
  DAT_100250c4._2_2_ = local_24.wDay;
  DAT_100250c8._0_2_ = local_24.wHour;
  DAT_100250c8._2_2_ = local_24.wMinute;
  DAT_100250cc._0_2_ = local_24.wSecond;
  DAT_100250cc._2_2_ = local_24.wMilliseconds;
LAB_1001a493:
      ...
      do {
        if (param_2 < (uint *)0xffffffe1) {
          ...
          if (puVar2 == (uint *)0x0) {
            ...
            piVar1 = HeapReAlloc(g_hProcessHeap,0,param_1,(SIZE_T)param_2);
          }
          else {
            if (DAT_100243c8 < param_2) {
LAB_1001a5b5:
              if (param_2 == (uint *)0x0) {
                param_2 = (uint *)0x1;
              }
              param_2 = (uint *)((int)param_2 + 0xfU & 0xfffffff0);
              piVar1 = HeapAlloc(g_hProcessHeap,0,(SIZE_T)param_2);
              if (piVar1 != (int *)0x0) {
...

{
  ...
  if (param_2 == 1) {
    ...
    if (iVar1 != 0) {
      _g_dwOSMinor = g_dwOSVersion >> 8 & 0xff;
      _g_dwOSMajor = g_dwOSVersion & 0xff;
      g_dwOSVersion = g_dwOSVersion >> 0x10;
      _g_dwOSBuild = _g_dwOSMajor * 0x100 + _g_dwOSMinor;
      iVar1 = FUN_1001c41c();
      if (iVar1 != 0) {
        g_pCommandLine = GetCommandLineA();
        g_pEnvironment = FUN_1001cfd9();
        FUN_1001cac3();
        FUN_1001cd8c();
        FUN_1001ccd3();
        FUN_1001c9a5();
        g_dwRefCount = g_dwRefCount + 1;
        goto LAB_1001a7a3;
      }
      FUN_1001a8b5();
    }
LAB_1001a730:
    ...
    if (param_2 == 0) {
      if (g_dwRefCount < 1) goto LAB_1001a730;
      g_dwRefCount = g_dwRefCount + -1;
      if (DAT_1002518c == 0) {
        FUN_1001c9e3();
      }
...

{
  ...
  if (param_2 != 0) {
    ...
    if ((DAT_100257b4 != (code *)0x0) &&
       (iVar2 = (*DAT_100257b4)(param_1,param_2,param_3), iVar2 == 0)) {
      return 0;
    }
...
LAB_1001a7f1:
  ...
  if (param_2 != 0) {
    if (DAT_100257b4 != (code *)0x0) {
      iVar2 = (*DAT_100257b4)(param_1,iVar1,param_3);
      return iVar2;
    }
    return param_2;
  }
...
{
  if ((DAT_100250dc == 1) || ((DAT_100250dc == 0 && (DAT_100250e0 == 1)))) {
    FUN_1001d10b();
  }
  FUN_1001d144(param_1);
  (*(code *)PTR___exit_10024300)(0xff);
  return;
}
...

{
  ...
  g_hProcessHeap = HeapCreate((uint)(param_1 == 0),0x1000,0);
  if (g_hProcessHeap != (HANDLE)0x0) {
    iVar1 = FUN_1001aa35();
    if (iVar1 != 0) {
      return 1;
    }
    HeapDestroy(g_hProcessHeap);
  }
  return 0;
}
...

{
  ...
  iVar1 = 0;
  if (0 < DAT_100257a4) {
    puVar2 = (undefined4 *)((int)g_pMemTracker + 0xc);
    do {
      VirtualFree((LPVOID)*puVar2,0x100000,0x4000);
      VirtualFree((LPVOID)*puVar2,0,0x8000);
      HeapFree(g_hProcessHeap,0,(LPVOID)puVar2[1]);
      puVar2 = puVar2 + 5;
      iVar1 = iVar1 + 1;
    } while (iVar1 < DAT_100257a4);
  }
  HeapFree(g_hProcessHeap,0,g_pMemTracker);
  HeapDestroy(g_hProcessHeap);
  return;
}
...

{
  ...
  InitializeCriticalSection((LPCRITICAL_SECTION)PTR_DAT_1002432c);
  InitializeCriticalSection((LPCRITICAL_SECTION)PTR_DAT_1002430c);
  return;
}
...

{
  ...
  ppuVar1 = (undefined **)&DAT_10024308;
  do {
    if (((((LPCRITICAL_SECTION)*ppuVar1 != (LPCRITICAL_SECTION)0x0) &&
         (ppuVar1 != &PTR_DAT_1002434c)) && (ppuVar1 != &PTR_DAT_1002433c)) &&
       ((ppuVar1 != &PTR_DAT_1002432c && (ppuVar1 != &PTR_DAT_1002430c)))) {
      DeleteCriticalSection((LPCRITICAL_SECTION)*ppuVar1);
      HeapFree_Wrapper(*ppuVar1);
    }
    ppuVar1 = ppuVar1 + 1;
  } while ((int)ppuVar1 < 0x100243c8);
  DeleteCriticalSection((LPCRITICAL_SECTION)PTR_DAT_1002432c);
  DeleteCriticalSection((LPCRITICAL_SECTION)PTR_DAT_1002433c);
  DeleteCriticalSection((LPCRITICAL_SECTION)PTR_DAT_1002434c);
  DeleteCriticalSection((LPCRITICAL_SECTION)PTR_DAT_1002430c);
  return;
}
...

{
  ...
  piVar1 = &DAT_10024308 + param_1;
  if ((&DAT_10024308)[param_1] == 0) {
...
{
  LeaveCriticalSection((LPCRITICAL_SECTION)(&DAT_10024308)[param_1]);
  return;
}
...
{
  g_pMemTracker = HeapAlloc(g_hProcessHeap,0,0x140);
  if (g_pMemTracker == (LPVOID)0x0) {
    return 0;
  }
  DAT_100257a0 = 0;
  DAT_100257a4 = 0;
  DAT_1002579c = g_pMemTracker;
  DAT_10025794 = 0x10;
  return 1;
}
...

{
  ...
  *piVar3 = *piVar3 + -1;
  uVar5 = DAT_10025798;
  puVar2 = DAT_100257a0;
  if ((*piVar3 == 0) && (uVar5 = uVar10, puVar2 = param_1, DAT_100257a0 != (uint *)0x0)) {
    VirtualFree((LPVOID)(DAT_10025798 * 0x8000 + DAT_100257a0[3]),0x8000,0x4000);
    DAT_100257a0[2] = DAT_100257a0[2] | 0x80000000U >> ((byte)DAT_10025798 & 0x1f);
    *(undefined4 *)(DAT_100257a0[4] + 0xc4 + DAT_10025798 * 4) = 0;
    *(char *)(DAT_100257a0[4] + 0x43) = *(char *)(DAT_100257a0[4] + 0x43) + -1;
    if (*(char *)(DAT_100257a0[4] + 0x43) == '\0') {
      DAT_100257a0[1] = DAT_100257a0[1] & 0xfffffffe;
    }
    puVar2 = param_1;
    if (DAT_100257a0[2] == 0xffffffff) {
      VirtualFree((LPVOID)DAT_100257a0[3],0,0x8000);
      HeapFree(g_hProcessHeap,0,(LPVOID)DAT_100257a0[4]);
      FUN_1001d2a0(DAT_100257a0,DAT_100257a0 + 5,
                   (DAT_100257a4 * 0x14 - (int)DAT_100257a0) + -0x14 + g_pMemTracker);
      DAT_100257a4 = DAT_100257a4 + -1;
      if (DAT_100257a0 < param_1) {
        param_1 = param_1 + -5;
      }
      DAT_1002579c = g_pMemTracker;
      puVar2 = param_1;
...

{
  ...
  puVar8 = g_pMemTracker + DAT_100257a4 * 5;
  uVar6 = (int)param_1 + 0x17U & 0xfffffff0;
  iVar7 = ((int)((int)param_1 + 0x17U) >> 4) + -1;
  bVar5 = (byte)iVar7;
  param_1 = DAT_1002579c;
  if (iVar7 < 0x20) {
  ...
  puVar11 = g_pMemTracker;
  if (param_1 == puVar8) {
    for (; (puVar11 < DAT_1002579c && ((puVar11[1] & local_c) == 0 && (*puVar11 & local_10) == 0));
        puVar11 = puVar11 + 5) {
    }
    param_1 = puVar11;
    if (puVar11 == DAT_1002579c) {
      for (; (puVar11 < puVar8 && (puVar11[2] == 0)); puVar11 = puVar11 + 5) {
      }
      puVar12 = g_pMemTracker;
      param_1 = puVar11;
      if (puVar11 == puVar8) {
        for (; (puVar12 < DAT_1002579c && (puVar12[2] == 0)); puVar12 = puVar12 + 5) {
        }
        param_1 = puVar12;
        if ((puVar12 == DAT_1002579c) && (param_1 = FUN_1001b0d2(), param_1 == (uint *)0x0)) {
          return (int *)0x0;
        }
      }
...
LAB_1001b08f:
  ...
  *(uint *)((int)piVar10 + (uVar6 - 4)) = uVar6 + 1;
  iVar7 = *piVar2;
  *piVar2 = iVar7 + 1;
  if (((iVar7 == 0) && (param_1 == DAT_100257a0)) && (local_8 == DAT_10025798)) {
    DAT_100257a0 = (uint *)0x0;
  }
  *piVar4 = local_8;
  return piVar10 + 1;
}
...

{
  ...
  if (DAT_100257a4 == DAT_10025794) {
    pvVar2 = HeapReAlloc(g_hProcessHeap,0,g_pMemTracker,(DAT_10025794 * 5 + 0x50) * 4);
    if (pvVar2 == (LPVOID)0x0) {
      return (undefined4 *)0x0;
    }
    DAT_10025794 = DAT_10025794 + 0x10;
    g_pMemTracker = pvVar2;
  }
  puVar1 = (undefined4 *)((int)g_pMemTracker + DAT_100257a4 * 0x14);
  pvVar2 = HeapAlloc(g_hProcessHeap,8,0x41c4);
  puVar1[4] = pvVar2;
  if (pvVar2 != (LPVOID)0x0) {
    ...
    HeapFree(g_hProcessHeap,0,(LPVOID)puVar1[4]);
  }
  return (undefined4 *)0x0;
}
...

{
  ...
  if (DAT_1002514c != (code *)0x0) {
    iVar1 = (*DAT_1002514c)(param_1);
    if (iVar1 != 0) {
      return 1;
    }
  }
...

{
  ...
  pvStack_14 = ExceptionList;
  ExceptionList = &pvStack_14;
  if (PTR_FUN_100243cc != (undefined *)0x0) {
    local_8 = 1;
    ExceptionList = &pvStack_14;
    (*(code *)PTR_FUN_100243cc)();
  }
  local_8 = 0xffffffff;
  FUN_1001b670();
  return;
...

{
  ...
  if (uVar3 != 0x65) {
    do {
      param_1 = param_1 + 1;
      if (DAT_100244c0 < 2) {
        uVar3 = (byte)PTR_DAT_100244cc[*param_1 * 2] & 4;
        this = PTR_DAT_100244cc;
      }
      else {
...

{
  ...
  FUN_1001a92a();
  DAT_100243f0 = TlsAlloc();
  if (DAT_100243f0 != 0xffffffff) {
    lpTlsValue = (DWORD *)FUN_1001e194(1,0x74);
    if (lpTlsValue != (DWORD *)0x0) {
      BVar1 = TlsSetValue(DAT_100243f0,lpTlsValue);
      if (BVar1 != 0) {
...

{
  FUN_1001a953();
  if (DAT_100243f0 != 0xffffffff) {
    TlsFree(DAT_100243f0);
    DAT_100243f0 = 0xffffffff;
  }
  return;
}
...
{
  *(undefined **)(param_1 + 0x50) = &DAT_10024710;
...

{
  ...
  lpTlsValue = TlsGetValue(DAT_100243f0);
  if (lpTlsValue == (DWORD *)0x0) {
    lpTlsValue = (DWORD *)FUN_1001e194(1,0x74);
    if (lpTlsValue != (DWORD *)0x0) {
      BVar1 = TlsSetValue(DAT_100243f0,lpTlsValue);
...
{
  if (DAT_100243f0 != 0xffffffff) {
    if ((param_1 != (LPVOID)0x0) || (param_1 = TlsGetValue(DAT_100243f0), param_1 != (LPVOID)0x0)) {
      ...
      if (*(undefined **)((int)param_1 + 0x50) != &DAT_10024710) {
        HeapFree_Wrapper(*(undefined **)((int)param_1 + 0x50));
      }
      HeapFree_Wrapper(param_1);
    }
    TlsSetValue(DAT_100243f0,(LPVOID)0x0);
    return;
  }
  return;
}
...

{
  ...
  if (((int)uVar3 < 0x46) || (0x8a < (int)uVar3)) {
    ...
    iVar4 = *(int *)(&DAT_1002487c + param_2 * 4) + param_3;
    ...
    iVar2 = ((param_4 + (uVar3 * 0x16d + iVar4 + (param_1 + -0x76d >> 2)) * 0x18) * 0x3c + param_5)
            * 0x3c + DAT_10024798 + 0x7c558180 + param_6;
    if ((param_7 == 1) ||
       (((param_7 == -1 && (DAT_1002479c != 0)) &&
        (local_14 = uVar3, local_c = iVar4, bVar1 = FUN_1001e4d6(local_28),
        CONCAT31(extraout_var,bVar1) != 0)))) {
      iVar2 = iVar2 + _DAT_100247a0;
    }
  }
  return iVar2;
}
...
{
  if (PTR_FUN_100242e0 != (undefined *)0x0) {
    (*(code *)PTR_FUN_100242e0)();
  }
...

{
  ...
  DAT_1002518c = 1;
  DAT_10025188 = (undefined1)param_3;
  if (param_2 == 0) {
    if ((DAT_10025790 != (undefined4 *)0x0) &&
       (puVar1 = (undefined4 *)(DAT_1002578c - 4), DAT_10025790 <= puVar1)) {
      do {
        if ((code *)*puVar1 != (code *)0x0) {
          (*(code *)*puVar1)();
        }
        puVar1 = puVar1 + -1;
      } while (DAT_10025790 <= puVar1);
    }
...

{
  ...
  DAT_10025780 = 0x20;
  DAT_10025680 = puVar2;
  for (; puVar2 < DAT_10025680 + 0x120; puVar2 = puVar2 + 9) {
  ...
  if ((local_4c.cbReserved2 != 0) && ((UINT *)local_4c.lpReserved2 != (UINT *)0x0)) {
    ...
    UVar9 = UVar8;
    if ((int)DAT_10025780 < (int)UVar8) {
      puVar2 = &DAT_10025684;
      do {
        puVar3 = _malloc(0x480);
        UVar9 = DAT_10025780;
        if (puVar3 == (undefined4 *)0x0) break;
        DAT_10025780 = DAT_10025780 + 0x20;
        *puVar2 = puVar3;
        puVar1 = puVar3;
        ...
        puVar2 = puVar2 + 1;
        UVar9 = UVar8;
      } while ((int)DAT_10025780 < (int)UVar8);
    }
    uVar7 = 0;
    if (0 < (int)UVar9) {
      do {
        if (((*(HANDLE *)local_8 != (HANDLE)0xffffffff) && ((*pUVar5 & 1) != 0)) &&
          ...
          puVar2 = (undefined4 *)((int)(&DAT_10025680)[(int)uVar7 >> 5] + (uVar7 & 0x1f) * 0x24);
  ...
  iVar6 = 0;
  do {
    puVar2 = DAT_10025680 + iVar6 * 9;
    if (DAT_10025680[iVar6 * 9] == -1) {
...

{
  ...
  iVar5 = 0;
  for (puVar6 = g_pEnvironment; (char)*puVar6 != '\0'; puVar6 = (uint *)((int)puVar6 + sVar2 + 1)) {
    if ((char)*puVar6 != '=') {
      iVar5 = iVar5 + 1;
    }
  ...
  cVar1 = (char)*g_pEnvironment;
  puVar6 = g_pEnvironment;
  while (cVar1 != '\0') {
    sVar2 = _strlen((char *)puVar6);
    if ((char)*puVar6 != '=') {
  ...
  HeapFree_Wrapper(g_pEnvironment);
  g_pEnvironment = (uint *)0x0;
  *puVar3 = 0;
  DAT_10025784 = 1;
  return;
}
...

{
  ...
  GetModuleFileNameA((HMODULE)0x0,&DAT_10025194,0x104);
  _DAT_10025180 = &DAT_10025194;
  pbVar2 = &DAT_10025194;
  if (*g_pCommandLine != 0) {
    pbVar2 = g_pCommandLine;
  }
  ...
  _DAT_10025168 = puVar1;
  _DAT_10025164 = local_8 + -1;
  return;
}
  ...
  *param_4 = 1;
  ...
  if (*param_1 == 0x22) {
    while( true ) {
      ...
      if (((*(byte *)((int)&DAT_10025560 + bVar1 + 1) & 4) != 0) &&
...
LAB_1001d030:
    ...
    if (DAT_10025298 == 1) goto LAB_1001d030;
    if (DAT_10025298 != 2) {
      return (LPSTR)0x0;
    }
  }
...

{
  ...
  do {
    ...
    pDVar2 = pDVar2 + 2;
    iVar5 = iVar5 + 1;
  } while ((int)pDVar2 < 0x100244b8);
  if (param_1 == (&DAT_10024428)[iVar5 * 2]) {
    if ((DAT_100250dc == 1) || ((DAT_100250dc == 0 && (DAT_100250e0 == 1)))) {
      pDVar2 = &param_1;
      puVar1 = (undefined4 *)(iVar5 * 8 + 0x1002442c);
      ...
      FUN_1001de90(local_a4,*(uint **)(iVar5 * 8 + 0x1002442c));
...

{
  ...
  if (param_1 + 1U < 0x101) {
    param_1._2_2_ = *(ushort *)(PTR_DAT_100244cc + param_1 * 2);
  }
  else {
    if ((PTR_DAT_100244cc[(param_1 >> 8 & 0xffU) * 2 + 1] & 0x80) == 0) {
...

{
  ...
  if (DAT_100253a0 == 0) {
    ...
    InterlockedIncrement((LONG *)&DAT_10025444);
    bVar1 = DAT_10025440 != 0;
    this = extraout_ECX;
    if (bVar1) {
      InterlockedDecrement((LONG *)&DAT_10025444);
      this = (void *)0x13;
      FUN_1001a9bf(0x13);
    }
...

{
  ...
  if (DAT_100253a0 == 0) {
    ...
    if ((int)param_1 < 0x100) {
      if (DAT_100244c0 < 2) {
        uVar2 = (byte)PTR_DAT_100244cc[param_1 * 2] & 1;
      }
      else {
    ...
    if ((PTR_DAT_100244cc[((int)uVar1 >> 8 & 0xffU) * 2 + 1] & 0x80) == 0) {
    ...
    iVar3 = FUN_1001f066(DAT_100253a0,0x100,(char *)&param_1,iVar3,(LPWSTR)&local_8,3,0,1);
    if (iVar3 != 0) {
      if (iVar3 == 1) {
...
{
  FUN_1001dafb(param_1,param_2,(int *)&DAT_100246d8);
  return;
}
...
{
  FUN_1001dafb(param_1,param_2,(int *)&DAT_100246f0);
  return;
}
...

{
  ...
  if ((DAT_100252a0 != (FARPROC)0x0) &&
     (bVar2 = FUN_1001e0f0(DAT_100252a0), CONCAT31(extraout_var,bVar2) != 0)) {
    iVar3 = (*DAT_100252a0)(param_1);
    return iVar3;
  }
  return 0;
}
...

{
  ...
  do {
    if (puVar3 < (uint *)0xffffffe1) {
      if (_Size < DAT_100243c8 || (int)_Size - (int)DAT_100243c8 == 0) {
        FUN_1001a9bf(9);
      ...
      piVar1 = HeapAlloc(g_hProcessHeap,8,(SIZE_T)puVar3);
      if (piVar1 != (int *)0x0) {
        return piVar1;
      }
    }
...

{
  ...
  DAT_10024830 = 0xffffffff;
  DAT_100252a8 = 0;
  _Str1 = (uint *)FUN_1001fc1a("TZ");
  if (_Str1 == (uint *)0x0) {
    FUN_1001aa20(0xc);
    DVar3 = GetTimeZoneInformation((LPTIME_ZONE_INFORMATION)&DAT_100252b0);
    if (DVar3 == 0xffffffff) {
      return;
    }
    DAT_10024798 = (void *)(DAT_100252b0 * 0x3c);
    DAT_100252a8 = 1;
    if (DAT_100252f6 != 0) {
      DAT_10024798 = (void *)((int)DAT_10024798 + DAT_10025304 * 0x3c);
    }
    if ((DAT_1002534a == 0) || (DAT_10025358 == 0)) {
      DAT_1002479c = 0;
      _DAT_100247a0 = 0;
    }
    else {
      DAT_1002479c = 1;
      _DAT_100247a0 = (DAT_10025358 - DAT_10025304) * 0x3c;
    }
    iVar4 = WideCharToMultiByte(DAT_100253b0,0x220,(LPCWSTR)&DAT_100252b4,-1,PTR_DAT_10024824,0x3f,
                                (LPCSTR)0x0,&local_8);
    if ((iVar4 == 0) || (local_8 != 0)) {
      *PTR_DAT_10024824 = 0;
    }
    else {
      PTR_DAT_10024824[0x3f] = 0;
    }
    iVar4 = WideCharToMultiByte(DAT_100253b0,0x220,(LPCWSTR)&DAT_10025308,-1,PTR_DAT_10024828,0x3f,
                                (LPCSTR)0x0,&local_8);
    if ((iVar4 != 0) && (local_8 == 0)) {
      PTR_DAT_10024828[0x3f] = 0;
      return;
    }
LAB_1001e4c0:
    *PTR_DAT_10024828 = 0;
    ...
    if (((char)*_Str1 != '\0') &&
       ((DAT_1002535c == (uint *)0x0 ||
        (iVar4 = _strcmp((char *)_Str1,(char *)DAT_1002535c), iVar4 != 0)))) {
      HeapFree_Wrapper(DAT_1002535c);
      sVar5 = _strlen((char *)_Str1);
      DAT_1002535c = _malloc(sVar5 + 1);
      if (DAT_1002535c != (uint *)0x0) {
        FUN_1001de80(DAT_1002535c,_Str1);
        FUN_1001aa20(0xc);
        _strncpy(PTR_DAT_10024824,(char *)_Str1,3);
        _Source = (uint *)((int)_Str1 + 3);
        PTR_DAT_10024824[3] = 0;
        cVar1 = *(char *)_Source;
        if (cVar1 == '-') {
          _Source = _Str1 + 1;
        }
        iVar4 = FUN_1001fb8f(this,(byte *)_Source);
        DAT_10024798 = (void *)(iVar4 * 0xe10);
        for (; (cVar2 = (char)*_Source, cVar2 == '+' || (('/' < cVar2 && (cVar2 < ':'))));
            _Source = (uint *)((int)_Source + 1)) {
        }
        if ((char)*_Source == ':') {
          _Source = (uint *)((int)_Source + 1);
          iVar4 = FUN_1001fb8f(DAT_10024798,(byte *)_Source);
          DAT_10024798 = (void *)((int)DAT_10024798 + iVar4 * 0x3c);
          ...
          if ((char)*_Source == ':') {
            _Source = (uint *)((int)_Source + 1);
            iVar4 = FUN_1001fb8f(DAT_10024798,(byte *)_Source);
            DAT_10024798 = (void *)((int)DAT_10024798 + iVar4);
            for (; ('/' < (char)*_Source && ((char)*_Source < ':'));
                _Source = (uint *)((int)_Source + 1)) {
            }
          }
        ...
        if (cVar1 == '-') {
          DAT_10024798 = (void *)-(int)DAT_10024798;
        }
        DAT_1002479c = (int)(char)*_Source;
        if (DAT_1002479c != 0) {
          _strncpy(PTR_DAT_10024828,(char *)_Source,3);
          PTR_DAT_10024828[3] = 0;
          return;
        }
        goto LAB_1001e4c0;
      }
...

{
  ...
  if (DAT_1002479c != 0) {
    uVar5 = param_1[5];
    if ((uVar5 != DAT_10024830) || (uVar5 != DAT_10024840)) {
      if (DAT_100252a8 == 0) {
        ...
        if (DAT_10025348 != 0) {
          uVar6 = (uint)DAT_1002534e;
          uVar3 = 0;
          uVar4 = 0;
        }
        else {
          uVar3 = (uint)DAT_1002534c;
          uVar6 = 0;
          uVar4 = (uint)DAT_1002534e;
        }
        FUN_1001e6a3(1,(uint)(DAT_10025348 == 0),uVar5,(uint)DAT_1002534a,uVar4,uVar3,uVar6,
                     (uint)DAT_10025350,(uint)DAT_10025352,(uint)DAT_10025354,(uint)DAT_10025356);
        if (DAT_100252f4 != 0) {
          uVar6 = (uint)DAT_100252fa;
          uVar3 = 0;
          uVar4 = 0;
          uVar5 = param_1[5];
        }
        else {
          uVar3 = (uint)DAT_100252f8;
          uVar6 = 0;
          uVar4 = (uint)DAT_100252fa;
          uVar5 = param_1[5];
        }
        FUN_1001e6a3(0,(uint)(DAT_100252f4 == 0),uVar5,(uint)DAT_100252f6,uVar4,uVar3,uVar6,
                     (uint)DAT_100252fc,(uint)DAT_100252fe,(uint)DAT_10025300,(uint)DAT_10025302);
      }
    }
    iVar1 = param_1[7];
    if (DAT_10024834 < DAT_10024844) {
      if ((DAT_10024834 <= iVar1) && (iVar1 <= DAT_10024844)) {
        if ((DAT_10024834 < iVar1) && (iVar1 < DAT_10024844)) {
          return true;
        }
LAB_1001e66f:
        iVar2 = ((param_1[2] * 0x3c + param_1[1]) * 0x3c + *param_1) * 1000;
        if (iVar1 == DAT_10024834) {
          return DAT_10024838 <= iVar2;
        }
        return iVar2 < DAT_10024848;
      }
    }
    else {
      ...
      if (DAT_10024834 < iVar1) {
        return true;
      }
      if ((iVar1 <= DAT_10024844) || (DAT_10024834 <= iVar1)) goto LAB_1001e66f;
    }
  }
  return false;
}
...

{
  ...
  if (param_2 == 1) {
    if ((param_3 & 3) == 0) {
      iVar1 = (&DAT_10024848)[param_4];
    }
    else {
      iVar1 = *(int *)(&DAT_1002487c + param_4 * 4);
    }
    ...
    if (param_5 == 5) {
      if ((param_3 & 3) == 0) {
        iVar2 = *(int *)(&DAT_1002484c + param_4 * 4);
      }
      else {
        iVar2 = *(int *)(&DAT_10024880 + param_4 * 4);
      }
      if (iVar2 < iVar1) {
        iVar1 = iVar1 + -7;
      }
  ...
  if (param_1 == 1) {
    DAT_10024830 = param_3;
    DAT_10024838 = ((param_8 * 0x3c + param_9) * 0x3c + param_10) * 1000 + param_11;
    DAT_10024834 = iVar1;
  }
  else {
    DAT_10024848 = ((param_8 * 0x3c + param_9) * 0x3c + _DAT_100247a0 + param_10) * 1000 + param_11;
    if (DAT_10024848 < 0) {
      DAT_10024848 = DAT_10024848 + 86400000;
      DAT_10024844 = iVar1 + -1;
    }
    else {
      DAT_10024844 = iVar1;
      if (86399999 < DAT_10024848) {
        DAT_10024848 = DAT_10024848 + -86400000;
        DAT_10024844 = iVar1 + 1;
      }
    }
...
LAB_1001e820:
      ...
      *(undefined1 *)puVar15 = 0;
      pbVar13 = (byte *)(iVar12 + 0x100248d0);
      do {
        bVar3 = *pbVar13;
        pbVar11 = pbVar13;
        while ((bVar3 != 0 && (bVar3 = pbVar11[1], bVar3 != 0))) {
          uVar8 = (uint)*pbVar11;
          if (uVar8 <= bVar3) {
            bVar4 = (&DAT_100248b8)[local_8];
            do {
              pbVar2 = (byte *)((int)&DAT_10025560 + uVar8 + 1);
              *pbVar2 = *pbVar2 | bVar4;
              uVar8 = uVar8 + 1;
            } while (uVar8 <= bVar3);
          }
      ...
      DAT_1002545c = 1;
      DAT_10025448 = CodePage;
      DAT_10025664 = FUN_1001e9da(CodePage);
      DAT_10025450 = *(undefined4 *)(iVar12 + 0x100248c4);
      DAT_10025454 = *(undefined4 *)(iVar12 + 0x100248c8);
      DAT_10025458 = *(undefined4 *)(iVar12 + 0x100248cc);
      goto LAB_1001e974;
    }
    goto LAB_1001e96f;
  }
...
code_r0x1001e824:
  pUVar5 = pUVar5 + 0xc;
  iVar12 = iVar12 + 1;
  if (0x100249af < (int)pUVar5) goto code_r0x1001e82f;
  goto LAB_1001e820;
code_r0x1001e82f:
  ...
  if (BVar6 == 1) {
    ...
    *(undefined1 *)puVar15 = 0;
    if (local_1c.MaxCharSize < 2) {
      ...
      if (local_1c.LeadByte[0] != '\0') {
        ...
        do {
          ...
          for (uVar7 = (uint)pBVar9[-1]; uVar7 <= bVar3; uVar7 = uVar7 + 1) {
            pbVar13 = (byte *)((int)&DAT_10025560 + uVar7 + 1);
            *pbVar13 = *pbVar13 | 4;
          }
          pBVar1 = pBVar9 + 1;
          pBVar9 = pBVar9 + 2;
      ...
      do {
        pbVar13 = (byte *)((int)&DAT_10025560 + uVar8 + 1);
        *pbVar13 = *pbVar13 | 8;
        uVar8 = uVar8 + 1;
      } while (uVar8 < 0xff);
      DAT_10025664 = FUN_1001e9da(CodePage);
...

{
  ...
  bVar2 = param_1 == -4;
  if (bVar2) {
    param_1 = DAT_100253b0;
  }
  DAT_10025364 = (uint)bVar2;
  return param_1;
}
...

{
  ...
  BVar2 = GetCPInfo(DAT_10025448,&local_18);
  if (BVar2 == 1) {
    uVar3 = 0;
    do {
    ...
    FUN_1001ef1d(1,local_118,0x100,local_518,DAT_10025448,DAT_10025664,0);
    FUN_1001f066(DAT_10025664,0x100,local_118,0x100,local_218,0x100,DAT_10025448,0);
    FUN_1001f066(DAT_10025664,0x200,local_118,0x100,local_318,0x100,DAT_10025448,0);
    uVar3 = 0;
    puVar7 = local_518;
    do {
      if ((*puVar7 & 1) == 0) {
        if ((*puVar7 & 2) != 0) {
          pbVar1 = (byte *)((int)&DAT_10025560 + uVar3 + 1);
          *pbVar1 = *pbVar1 | 0x20;
          uVar8 = *(undefined1 *)((int)local_318 + uVar3);
          goto LAB_1001eb42;
        }
        (&DAT_10025460)[uVar3] = 0;
      }
      else {
        pbVar1 = (byte *)((int)&DAT_10025560 + uVar3 + 1);
        *pbVar1 = *pbVar1 | 0x10;
...

{
  ...
  iVar1 = 0;
  if (g_pfnMessageBoxA == (FARPROC)0x0) {
    hModule = LoadLibraryA("user32.dll");
    if (hModule != (HMODULE)0x0) {
      g_pfnMessageBoxA = GetProcAddress(hModule,"MessageBoxA");
      if (g_pfnMessageBoxA != (FARPROC)0x0) {
        g_pfnGetActiveWindow = GetProcAddress(hModule,"GetActiveWindow");
        g_pfnGetLastActivePopup = GetProcAddress(hModule,"GetLastActivePopup");
        goto LAB_1001ec26;
      }
    }
    iVar1 = 0;
...
LAB_1001ec26:
    if (g_pfnGetActiveWindow != (FARPROC)0x0) {
      iVar1 = (*g_pfnGetActiveWindow)();
      if ((iVar1 != 0) && (g_pfnGetLastActivePopup != (FARPROC)0x0)) {
        iVar1 = (*g_pfnGetLastActivePopup)(iVar1);
      }
    }
    iVar1 = (*g_pfnMessageBoxA)(iVar1,param_1,param_2,param_3);
  }
  return iVar1;
}
...
LAB_1001ee58:
    if (param_1 == (DWORD *)0x8) {
      if (DAT_10024788 < DAT_1002478c + DAT_10024788) {
        iVar4 = DAT_10024788 * 0xc;
        iVar5 = DAT_10024788;
        do {
          iVar4 = iVar4 + 0xc;
...

{
  ...
  if (*(int *)(param_2 + 4) != param_1) {
    ...
    do {
      uVar2 = uVar3 + 0xc;
      if (param_2 + DAT_10024794 * 0xc <= uVar2) break;
      piVar1 = (int *)(uVar3 + 0x10);
      uVar3 = uVar2;
    } while (*piVar1 != param_1);
  }
  if ((param_2 + DAT_10024794 * 0xc <= uVar2) || (*(int *)(uVar2 + 4) != param_1)) {
    uVar2 = 0;
  }
  return uVar2;
}
...
LAB_1001f49f:
    ...
    if (bVar6 == DAT_100244c4) goto LAB_1001f4ae;
    if (bVar6 == 0x2b) {
      local_2c = 0;
      iVar9 = 2;
      iVar5 = local_14;
...
LAB_1001f4ae:
  ...
  case 3:
    ...
    while( true ) {
      if (DAT_100244c0 < 2) {
        uVar3 = (byte)PTR_DAT_100244cc[(uint)bVar6 * 2] & 4;
        this = PTR_DAT_100244cc;
      }
      else {
        pbVar7 = (byte *)0x4;
    ...
    iVar9 = iVar1;
    iVar5 = local_14;
    if (bVar6 != DAT_100244c4) goto LAB_1001f620;
    goto LAB_1001f482;
  case 4:
    local_14 = 1;
    local_28 = 1;
...

{
  ...
  while( true ) {
    if (DAT_100244c0 < 2) {
      uVar1 = (byte)PTR_DAT_100244cc[(uint)*param_1 * 2] & 8;
      this = PTR_DAT_100244cc;
    }
    else {
  ...
  while( true ) {
    if (DAT_100244c0 < 2) {
      uVar2 = (byte)PTR_DAT_100244cc[uVar4 * 2] & 4;
    }
    else {
...

{
  ...
  if (((DAT_10025784 != 0) &&
      ((DAT_10025170 != (int *)0x0 ||
       (((DAT_10025178 != 0 && (iVar1 = FUN_10020073(), iVar1 == 0)) && (DAT_10025170 != (int *)0x0)
        ))))) && (piVar3 = DAT_10025170, param_1 != (uchar *)0x0)) {
...

{
  ...
  ppuVar3 = &PTR_DAT_10024cd0;
  if (param_2 != 0) {
    if ((int)param_2 < 0) {
      param_2 = -param_2;
      ppuVar3 = (undefined **)0x10024e30;
    }
    if (param_3 == 0) {
...

{
  ...
  iVar1 = FUN_100202c1(DAT_10025664,1,_Str1,_MaxCount,_Str2,_MaxCount,DAT_10025448);
  if (iVar1 == 0) {
    return 0x7fffffff;
  }
  return iVar1 + -2;
...

{
  ...
  lpWideCharStr = (LPCWSTR)*DAT_10025178;
  puVar2 = DAT_10025178;
  while( true ) {
...
LAB_1002013e:
    ...
    LOCK();
    _DAT_10025444 = _DAT_10025444 + 1;
    UNLOCK();
    bVar1 = 0 < DAT_10025440;
    if (bVar1) {
      LOCK();
      UNLOCK();
      _DAT_10025444 = iVar2;
...

{
  ...
  if (DAT_10025170 == DAT_10025174) {
    DAT_10025170 = FUN_10020748(DAT_10025170);
  }
  if (DAT_10025170 == (int *)0x0) {
    if ((param_2 == 0) || (DAT_10025178 == (undefined4 *)0x0)) {
      if (bVar7) {
        return 0;
      }
      DAT_10025170 = _malloc(4);
      if (DAT_10025170 == (int *)0x0) {
        return 0xffffffff;
      }
      *DAT_10025170 = 0;
      if (DAT_10025178 == (undefined4 *)0x0) {
        DAT_10025178 = _malloc(4);
        if (DAT_10025178 == (undefined4 *)0x0) {
          return 0xffffffff;
        }
        *DAT_10025178 = 0;
...

{
  ...
  _Str2 = (uchar *)*DAT_10025170;
  piVar2 = DAT_10025170;
  while( true ) {
    if (_Str2 == (uchar *)0x0) {
      return -((int)piVar2 - (int)DAT_10025170 >> 2);
    }
...

{
  ...
  if (DAT_1002545c == 0) {
    ...
    while( true ) {
      ...
      uVar3 = (uint)bVar1;
      if (bVar1 == 0) break;
      if ((*(byte *)((int)&DAT_10025560 + uVar3 + 1) & 4) == 0) {
        pbVar2 = param_1;
